...
if(isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true){
  ...
  global $otpValue;
  if ($_SESSION['otpValue'] == $_POST['otpinputfield']) {
    ...
    $recoveryEmail = $_SESSION['recovery-email'];
    ...
    $sqlInsertCommand = "insert into sys_users (first_name, last_name, email, recovery_email, password_hash) values('$firstName','$lastName','$email','$recoveryEmail','$passwordHash');";
    $result = $connection->query($sqlInsertCommand);
    $_SESSION['otp_session'] = true;
    header("refresh: 3; url = http://localhost/mini-project/success.php");
  } else {
